...
Tugas 3 - Aplikasi Penghitungan Diskon
...
public class AplikasiPerhitunganDiskon extends javax.swing.JFrame {
    ...
    private void txtHargaAwalFocusGained(java.awt.event.FocusEvent evt) {                                         
        txtHargaAwal.setText("");
    }                                        

    private void txtHargaAwalKeyTyped(java.awt.event.KeyEvent evt) {                                      
...
## Screenshots
![image](https://github.com/user-attachments/assets/5cf936b9-eeec-408a-849c-2fe1d0faa38e)
